...
//   useEffect(() => {
//     setSocket(io('http://localhost:6000'))
// }, [])
...
//         <div className="cursor-pointer ml-4 mt-10" onClick={()=><Chat/>}>
...
//       </svg>
//         </div>
//         <div className="cursor-pointer ml-4 mt-10" onClick={()=><Groupchat/>}>
...
//     </svg>
//       </div>
//       <div className="cursor-pointer ml-4 mt-10 " onClick={()=><Chatbot />}>
...
//         </div>
//         <hr />
//         <div className="border border-primary p-[20px] rounded "> Create New Group </div>
